...
where L is the Avogadro constant (6.022 × 10²³ mol⁻¹) and PARλ is the actinic photon flux density at wavelength λ (µmol photons m⁻² s⁻¹), converted to photons nm⁻² s⁻¹. All calculations were performed by WinControl-3 software (Heinz Walz GmbH). The resulting σ(II)λ values (nm²) were exported as semicolon-delimited CSV files and analysed using the CyanoTools Sigma(II) Analyzer (https://www.cyano.tools/sigma).
