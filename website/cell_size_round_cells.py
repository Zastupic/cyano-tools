                    ...
                    if 'coordinates_all_in_session' in session:    
                        ...
                        for i in range(len(rough_coordinates)):
                            ...
                            if circle is not None:
                                ...
                                # Draw cell number 
                                cv2.putText(img_orig_copy, str(cell_number), (a, b), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (245, 235, 15), 2) # type: ignore
                                # Draw circle
                                cv2.circle(img_orig_copy, (a, b), cell_radius_incremented, (0, 255, 0), 2) # type: ignore
                                # Draw line
