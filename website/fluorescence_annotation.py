...
FIELDS: dict[str, FieldDef] = {
    ...
    "medium_modification":    FieldDef("study", "optional", "str",
                                       ...
                                       group="conditions",
                                       sample_cond="liquid_culture"),
    "medium_ph":              FieldDef("study", "optional", "float",
                                       "Medium pH",
                                       miappe="Growth condition",
                                       group="conditions",
                                       sample_cond="liquid_culture"),
    "medium_buffer_type":     FieldDef("study", "optional", "str",
                                       "Medium buffer type",
                                       vocab=["phosphate", "HEPES", "Tris",
                                              "MOPS", "MES", "PIPES",
                                              "bicarbonate", "citrate",
                                              "acetate", "other"],
                                       miappe="Growth condition",
                                       group="conditions",
                                       sample_cond="liquid_culture"),
    "medium_buffer_concentration": FieldDef("study", "optional", "float",
                                       "Medium buffer concentration (mM)",
                                       miappe="Growth condition",
                                       group="conditions",
                                       sample_cond="liquid_culture"),
    ...
    "fo_timing":              FieldDef("fluorometer", "recommended", "str",
                                       ...
                                       group="acquisition"),
    "detector_gain":          FieldDef("fluorometer", "optional", "float",
                                       "Detector gain",
                                       group="acquisition"),
    "damping":                FieldDef("fluorometer", "optional", "float",
                                       "Damping",
                                       group="acquisition"),
    "detector_bandpass_filter": FieldDef("fluorometer", "optional", "str",
                                         "Detector bandpass filter",
                                         group="acquisition"),
    "sample_holder_type":     FieldDef("fluorometer", "optional", "str",
                                       "Sample holder type",
                                       vocab=["cuvette", "leaf-clip", "probe",
                                              "fiber optics"],
                                       group="acquisition"),
    "stirring":               FieldDef("fluorometer", "optional", "str",
                                       "Sample stirring",
                                       vocab=["off", "on"],
                                       sample_cond="liquid_culture",
                                       group="acquisition"),
